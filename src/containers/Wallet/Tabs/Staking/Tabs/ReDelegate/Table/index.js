...
import { setSortOrder, setSortOrderBy } from '../../../../../../../actions/reDelegate';
                                        ...
                                        .map((row, index) => {
                                            return (
                                                <TableRow
                                                    ...
                                                    <TableCell align="right" className="table_cell table_cell7">
                                                        <ReDelegateButton value={row}/>
                                                    </TableCell>
                                                </TableRow>
                                            );
                                        })
...
const stateToProps = (state) => {
    return {
        ...
        order: state.staking.reDelegate.order,
        orderBy: state.staking.reDelegate.orderBy,
        rowsPerPage: state.staking.reDelegate.rowsPerPage,
        page: state.staking.reDelegate.page,
        validatorsList: state.staking.delegationsValidators.list,
        inProgress: state.staking.delegationsValidators.inProgress,
        searchValue: state.staking.reDelegate.searchList,
    };
};
...
export default connect(stateToProps, actionsToProps)(ReDelegateTable);
