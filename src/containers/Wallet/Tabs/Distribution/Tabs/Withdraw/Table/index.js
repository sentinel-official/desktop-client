...
import { setSortOrder, setSortOrderBy } from '../../../../../../../actions/distribution';
...
import '../../../../Staking/Tabs/Delegate/Table/index.css';
...
const stateToProps = (state) => {
    return {
        ...
        order: state.distribution.withdraw.order,
        orderBy: state.distribution.withdraw.orderBy,
        rowsPerPage: state.distribution.withdraw.rowsPerPage,
        page: state.distribution.withdraw.page,
        validatorsList: state.staking.delegationsValidators.list,
        inProgress: state.staking.delegationsValidators.inProgress,
        searchValue: state.distribution.withdraw.searchList,
    };
};
...
export default connect(stateToProps, actionsToProps)(WithdrawTable);
