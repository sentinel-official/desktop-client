...
import { hideWithdrawSuccessDialog } from '../../../../../../../actions/distribution';
...
class WithdrawDialog extends Component {
    ...
    render () {
        return (
            <Dialog
                aria-describedby="withdraw-success-dialog-description"
                aria-labelledby="withdraw-success-dialog-title"
                className="dialog success_dialog"
                open={this.props.open}
                onClose={this.props.handleClose}>
                <DialogTitle id="withdraw-success-dialog-title">
                    <div className="header">
                        <p>
                            <b className="text1">
                                {variables[this.props.lang].TI_withdraw}
...
const stateToProps = (state) => {
    return {
        ...
        open: state.distribution.withdraw.withdrawDialog.success,
...
const actionsToProps = {
    handleClose: hideWithdrawSuccessDialog,
    setIntervalValue,
    transactionHash,
};

export default connect(stateToProps, actionsToProps)(WithdrawDialog);
